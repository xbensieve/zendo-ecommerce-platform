...
public class CartController {
    ...
    @PreAuthorize("hasRole('CUSTOMER')")
    public ResponseEntity<ApiResponse<Void>> addItem(@AuthenticationPrincipal AuthenticatedUser user, @RequestBody AddItemRequest request) {
    ...
    @PreAuthorize("hasRole('CUSTOMER')")
    public ResponseEntity<ApiResponse<Void>> removeItem(@AuthenticationPrincipal AuthenticatedUser user, @PathVariable String sku) {
    ...
    @PreAuthorize("hasRole('CUSTOMER')")
    public ResponseEntity<ApiResponse<Void>> updateQuantity(@AuthenticationPrincipal AuthenticatedUser user, @PathVariable String sku, @RequestBody UpdateQuantityRequest request) {
